...
export class CharactersComponent/* implements OnInit */ {
  ...
  constructor(public characterService: CharacterService, private messageService: MessageService) { }
  ...
  getKanjis(): void {
    this.characterService.getAllKanji()
      .subscribe(kanji => {
        this.kanjis = kanji
  ...
  onSelect(character: Character): void {
    ...
    this.characterService.addKanji(character);
    this.messageService.add(`CharactersComponent: Selected character id=${character.New}`);
  }
  ...
  //  console.log('gfgfhg', btnArr)
    ...
    // gsap.to(`.btn${kan.nr}`, { zIndex: 2, scale: 1 })
  }
